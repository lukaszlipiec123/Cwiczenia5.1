...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static int Task13(int[] arr)
        {
            ...
            int result = arr.GroupBy(numInArray => numInArray)
                .OrderBy(num => num.Count() % 2 == 1).Select(grouped => grouped.Key)
                .Last();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = Depts.Where(dept =>
               Emps.Where(emp => emp.Deptno == dept.Deptno).Count() == 5 
               ||
